# -*- coding: utf-8 -*-
#
# OpenCV_Docs documentation build configuration file, created by
...
htmlhelp_basename = 'OpenCV_Docsdoc'
...
latex_documents = [
  ('index', 'OpenCV_Docs.tex', u'OpenCV\\_Docs Documentation',
   u'Ana Huaman', 'manual'),
]
...
man_pages = [
    ('index', 'opencv_docs', u'OpenCV_Docs Documentation',
     [u'Ana Huaman'], 1)
]
...
texinfo_documents = [
  ('index', 'OpenCV_Docs', u'OpenCV_Docs Documentation',
   u'Ana Huaman', 'OpenCV_Docs', 'One line description of project.',
   'Miscellaneous'),
]
